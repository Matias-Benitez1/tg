...
public class contactoPage extends Base {
	...
	By messageLocator = By.xpath("//*[@id=\"post-1487\"]/div/div/div/div[1]/div[2]/div[2]/div[2]/div/p[3]/strong");
	...
	public String nosotrosMessage() {
		List<WebElement> strong = findElements(messageLocator);
		return getText(strong.get(0));
